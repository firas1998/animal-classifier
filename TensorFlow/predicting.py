...
img_for_prediction = img.reshape((1,50,50,3)) #reshape multidimentional array to have the shape 1x50x50x3, 1 being the number of samples

img_for_prediction = img_for_prediction.astype("float")/255 #convert image values to float, and shrink them between 0 and 1
